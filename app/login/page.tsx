    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-[#FAFAFA] p-4 font-sans selection:bg-[#8BFDA8] selection:text-black">
      <div className="w-full max-w-[420px] bg-white rounded-[32px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[#F0F0F0] p-8 md:p-10 animate-in fade-in zoom-in-95 duration-300">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          {mode === 'forgot' && (
             <h1 className="text-[22px] font-bold text-black text-center mt-2 mb-2">Забыли пароль?</h1>
          )}
          {mode === 'update' && (
             <h1 className="text-[22px] font-bold text-black text-center mt-2 mb-2">Новый пароль</h1>
          )}
        </div>
          ...
          {mode === 'register' && (
            <div className="flex flex-col gap-1.5">
              ...
              <input 
                ...
                className="w-full h-[52px] bg-white border border-[#E5E5EA] focus:border-[#8BFDA8] focus:ring-4 focus:ring-[#8BFDA8]/20 rounded-[14px] px-4 text-[16px] text-black outline-none transition-all placeholder:text-[#C7C7CC]"
