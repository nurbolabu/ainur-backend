    ...
    <div className="min-h-[100dvh] bg-[#F2F2F7] flex items-center justify-center p-4 font-sans text-[#000000] selection:bg-[#8BFDA8]">
      <div className="w-full max-w-[400px] animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="flex flex-col items-center mb-8">
          <svg className="w-[200px] h-auto mb-4" viewBox="0 0 99 14" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <p className="text-[15px] text-[#8E8E93] mt-2">Умные виджеты для вашего бизнеса</p>
        </div>
        ...
        <div className="bg-[#FFFFFF] border border-[#E5E5EA] rounded-[24px] overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-4 pt-6 flex flex-col gap-4">
            ...
            {!isLogin && (
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-[#F5F5F7] border border-[#E5E5EA] rounded-[14px] h-[50px] px-4 text-[16px] outline-none focus:bg-[#FFFFFF] focus:border-[#8BFDA8] transition-colors"
            ...
            <button 
              type="submit" 
              disabled={isLoading}
              className="w-full bg-[#8BFDA8] text-[#000000] font-semibold text-[16px] rounded-[14px] h-[50px] mt-4 flex items-center justify-center active:scale-95 transition-transform disabled:opacity-50"
            >
