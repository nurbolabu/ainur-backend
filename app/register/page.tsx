...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // 1. Регистрация пользователя (Confirm Email выключен в Supabase)
      ...
      if (authData.user && authData.session) {
        ...
        // Если сессия не вернулась (например, включен Confirm email вопреки настройкам)
        setSuccessMsg('Аккаунт создан! Проверьте почту для активации входа.');
      }
