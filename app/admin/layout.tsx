  ...
  return (
    <div className="min-h-[100dvh] bg-[#F2F2F7] flex justify-center font-sans text-[#000000] selection:bg-[#8BFDA8]">
      ...
      <style jsx global>{`
        ...
        .btn-sec { background-color: transparent; border: 2px solid #000000; color: #000000; font-weight: 700; border-radius: 16px; padding: 14px 24px; transition: all 0.2s ease; display: inline-flex; align-items: center; justify-content: center; gap: 8px; font-size: 16px; cursor: pointer; }
        ...
        .input-ios:disabled { opacity: 0.6; cursor: not-allowed; }
      `}</style>
    </div>
  );
}