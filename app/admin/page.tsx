  ...
  return (
    <div className="animate-in fade-in duration-500">
      ...
      <div className="mt-10">
        ...
        <div className="h-64 bg-white/50 border border-white rounded-[24px] flex items-center justify-center text-gray-400 font-medium">
          Здесь появится таблица последних действий...
        </div>
      </div>
    </div>
  );
