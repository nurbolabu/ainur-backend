...
export default function SettingsPage() {
  ...
  async function handleSave() {
    ...
    setIsDirty(false); setShowModal(false); alert('Настройки успешно сохранены');
  }
  ...
  return (
    <div className="animate-in fade-in duration-300 relative px-1 md:px-0">
      <div className="flex justify-between items-center mb-6">
        ...
        <button onClick={handleSave} className={`btn-primary w-auto !min-h-[44px] !h-[44px] !py-0 !px-5 !text-[15px] ${!isDirty && 'opacity-50 pointer-events-none'}`}>Сохранить</button>
      </div>
      ...
      <div className="space-y-8" onClick={handleFakeNav}>
        ...
        <section>
          ...
          <div className="ios-module mb-0 flex flex-col">
            <div className="px-4 py-3 relative border-b border-[#E5E5EA]">
              ...
              <input className="w-full text-[17px] outline-none text-[#000000] placeholder-[#8E8E93]" placeholder="Введите название" value={formData.company_name} onChange={e => handleChange('company_name', e.target.value)} />
            </div>
            <div className="px-4 py-3 relative flex justify-between items-center h-[60px]">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="w-8 h-8 rounded-full overflow-hidden border border-[#E5E5EA]">
        ...
        <section>
          ...
          <div className="ios-module mb-0 flex flex-col">
            <div className="px-4 py-3 relative border-b border-[#E5E5EA]">
              <label className="text-[13px] font-semibold text-[#8E8E93] block mb-1">Системная роль</label>
              <textarea className="w-full text-[17px] outline-none text-[#000000] resize-none" rows={3} placeholder="Инструкция для ИИ..." value={formData.system_prompt} onChange={e => handleChange('system_prompt', e.target.value)} />
            </div>
            <div className="px-4 py-3 relative">
              <label className="text-[13px] font-semibold text-[#8E8E93] block mb-1">База знаний</label>
              <textarea className="w-full text-[17px] outline-none text-[#000000] resize-none" rows={6} placeholder="Текст, на который опирается ИИ при ответах..." value={formData.knowledge_base} onChange={e => handleChange('knowledge_base', e.target.value)} />
            </div>
          </div>
        </section>
      </div>
          ...
          <div className="animate-in slide-in-from-bottom-4 duration-300 max-w-[500px] w-full mx-auto">
            <div className="bg-[#F2F2F7]/95 backdrop-blur-xl rounded-[14px] overflow-hidden mb-2">
              <div className="p-4 text-center border-b border-[#C6C6C8]">
                ...
                <span className="text-[13px] text-[#8E8E93] font-medium block">Вы хотите их сохранить?</span>
              </div>
