...
import { Settings, Plus, Trash2, Loader2, PlaySquare } from 'lucide-react';
  ...
  return (
    <div className="w-full max-w-[690px] mx-auto px-[17px] md:px-0 pt-[100px] animate-in fade-in duration-300 flex flex-col gap-6 pb-[100px]">
      ...
      <div className="px-1 mt-2">
        <h1 className="text-[28px] font-bold text-[#000000]">Stories</h1>
      </div>

      {/* 3. СЕТКА СТОРИС (4 в ряд на ПК, 2 в ряд на мобилках) */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-2.5">
        
        {/* Кнопка добавления */}
        <label className="aspect-[9/16] bg-[#000000] rounded-[22px] p-5 flex flex-col justify-between shrink-0 active:scale-95 transition-transform cursor-pointer relative">
           ...
           <div className="text-[#FFFFFF] text-[20px] font-medium leading-tight">Добавить<br/>Stories</div>
        ...
        {stories.map((s) => {
          ...
          return (
            <div key={s.id} className="aspect-[9/16] bg-[#FFFFFF] rounded-[22px] p-5 flex flex-col justify-between border border-[#E5E5EA] relative overflow-hidden group">
              ...
              <button 
                ...
                className="w-10 h-10 rounded-[20px] bg-[#FFFFFF]/90 backdrop-blur-md flex items-center justify-center text-[#FF3B30] relative z-10 active:scale-95 transition-transform"
              >
                <Trash2 size={18} strokeWidth={1.5} />
              </button>
              
              <div className="text-[#FFFFFF] text-[15px] font-medium relative z-10">
